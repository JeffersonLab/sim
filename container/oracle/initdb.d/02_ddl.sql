...
(
   ...
   OPS_IMPACT              SMALLINT DEFAULT 1 NOT NULL,
   PAST_DOWNTIME           SMALLINT DEFAULT 1 NOT NULL,
   DEBUGGABILITY_N_TESTING SMALLINT DEFAULT 1 NOT NULL,
   CODE_COMPLEXITY         SMALLINT DEFAULT 1 NOT NULL,
   DOCUMENTATION_GAPS      SMALLINT DEFAULT 1 NOT NULL,
   ESOTERICISM             SMALLINT DEFAULT 1 NOT NULL,
   ...
   RISK_SCORE              SMALLINT GENERATED ALWAYS AS (((PAST_DOWNTIME + DEBUGGABILITY_N_TESTING + CODE_COMPLEXITY + DOCUMENTATION_GAPS + ESOTERICISM) / 5) + OPS_IMPACT) VIRTUAL,
