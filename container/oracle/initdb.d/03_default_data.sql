...
-- SOFTWARE
insert into SIM_OWNER.SOFTWARE (SOFTWARE_ID, NAME, CODE_URL, DOC_URL, MAINTAINER_USERNAME_CSV) values (SOFTWARE_ID.nextval, 'SIM', 'https://github.com/jeffersonlab/sim', 'https://github.com/jeffersonlab/sim', 'ryans');